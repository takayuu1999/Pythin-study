...
class Person:
    ...
    # 個人情報を表示
    def disp_info(self):
        print("名前：{} 年齢：{} 性別：{} 身長：{} 体重：{}".format(Person.__name, Person.__age, Person.__gender, Person.__height, Person.__weight))
...
# 年齢を44、身長を178.5、体重を88.9に修正
person.set_age(44)
person.set_height(178.5)
person.set_weight(88.9)
